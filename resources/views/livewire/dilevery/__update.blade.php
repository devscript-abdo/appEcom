                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-4 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input readonly type="text" wire:model.defer="fields.password" name="password" id="password" class="form-control @error('password') is-invalid @enderror" onclick="generatePassword()" value="" placeholder="{{__('adminCrud.admin.password')}}">
                                    @error('password')
                                    <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="col-lg-12 mt-3">
                                <button wire:click.prevent="update()" class="btn btn-primary">{{__('deliveryData.delivery.update.btn')}}</button>
