                        ...
                        <div class="row clearfix">
                                <div class="col-lg-3 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" wire:model.defer="nom" name="nom" class="form-control @error('nom') is-invalid @enderror" placeholder="{{__('adminCrud.admin.nom')}}">
                                        @error('nom')
                                ...
                                <div class="col-lg-3 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="email" wire:model.defer="email" name="email" class="form-control @error('email') is-invalid @enderror" placeholder="{{__('adminCrud.admin.email')}}">
                                        @error('email')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-lg-3 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" wire:model.defer="tele" name="tele" class="form-control @error('tele') is-invalid @enderror" placeholder="{{__('adminCrud.admin.tele')}}">
                                        @error('tele')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-lg-5 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select wire:model.defer="ville" name="ville" class="custom-select @error('ville') is-invalid @enderror">
                                ...
                                <div class="col-lg-7 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" wire:model.defer="address" name="address" class="form-control @error('address') is-invalid @enderror" placeholder="{{__('adminCrud.admin.address')}}">
                                        @error('address')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-lg-4 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" wire:model.defer="password" name="password" class="form-control @error('password') is-invalid @enderror" onclick="generatePassword()" value="" placeholder="{{__('adminCrud.admin.password')}}" readonly>
                                        @error('password')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
